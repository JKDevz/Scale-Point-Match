...
public class PlayerManager : MonoBehaviour
{
    ...
    public void OnSinglePlayerPlayButtonClick()
    {
    ...
    player1Text != null && player2Text != null)
        {
            ...
            player1Data.playerInfo.name = singlePlayerNameInput.text;
            player2Data.playerInfo.name = aiNameText.text;
        }
        else
        {
    ...
    public void OnMultiplayerPlayButtonClick()
    {
        if (player1NameInput != null && player2NameInput != null &&
            player1Data != null && player2Data != null &&
            player1Text != null && player2Text != null)
